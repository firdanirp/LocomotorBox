...
void loop()
{
  ...
  if (reset1_1==1){
    ...
    //Reset the reference to 0:0:0 from the second Day
    ...
    if (phase1_1 == 0)
    {
      if (intHour*60 +  intMinute*60 >= HourOn1_1 * 60 + MinuteOn1_1 && (HourOn1_1 * 60 + MinuteOn1_1) - (intHour*60 + intMinute*60) <= T_Cycle1_1 * (RatioOn1_1/RatioOff1_1) * 60)
      {
...
void printMeasurement()
{
  ...
  for (int i = 0; i < (999); i++)
  {
    ...
    delay(1); // sampling 1000 times per minute
  }
