...
def plot_box1():
    ...
    for name, group in dategroup:
        ...
        axes[j, 0].axes.set_xticklabels(
            [0, 3, 6, 9, 12, 15, 18, 21, 24], rotation=0, size=7.5)
...
if __name__ == '__main__':
    ...
    #create Plot menu
    plotmenu = Menu(menu)
    plotmenu.add_command(label='Load data', command=read_data)
    plotmenu.add_command(label='Plot Box1', command=plot_box1)
    plotmenu.add_command(label='Plot Box2', command=plot_box2)
    plotmenu.add_command(label='Plot Box3', command=plot_box3)
    plotmenu.add_command(label='Plot Box4', command=plot_box4)
    plotmenu.add_command(label='Plot Box5', command=plot_box5)
    plotmenu.add_command(label='Plot Box6', command=plot_box6)
    plotmenu.add_command(label='Plot Box7', command=plot_box7)
    plotmenu.add_command(label='Plot Box8', command=plot_box8)
    plotmenu.add_command(label='Plot Box9', command=plot_box9)
    plotmenu.add_command(label='Plot Box10', command=plot_box10)
    menu.add_cascade(label='Actogram Plot', menu=plotmenu)
    #create About menu
    aboutmenu = Menu(menu)
