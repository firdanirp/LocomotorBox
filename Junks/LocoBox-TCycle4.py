...
if __name__ == '__main__':
    ...
    spin0_10.insert(0, '12')
    spin0_11 = Spinbox(tab0, from_=00, to=24, width=3, format='%02.0f')
    spin0_11.delete(0, 'end')
    spin0_11.insert(0, '12')
    spin0_12 = Spinbox(tab0, from_=00, to=24, width=3, format='%02.0f')
    spin0_12.delete(0, 'end')
    spin0_12.insert(0, '12')

    spin0_13 = Spinbox(tab0, from_=00, to=24, width=3, format='%02.0f')
    spin0_13.delete(0, 'end')
    spin0_13.insert(0, '12')
    spin0_14 = Spinbox(tab0, from_=00, to=24, width=3, format='%02.0f')
    spin0_14.delete(0, 'end')
    spin0_14.insert(0, '12')
    spin0_15 = Spinbox(tab0, from_=00, to=24, width=3, format='%02.0f')
    spin0_15.delete(0, 'end')
    spin0_15.insert(0, '12')
    spin0_16 = Spinbox(tab0, from_=00, to=24, width=3, format='%02.0f')
    spin0_16.delete(0, 'end')
    spin0_16.insert(0, '12')
    spin0_17 = Spinbox(tab0, from_=00, to=24, width=3, format='%02.0f')
    spin0_17.delete(0, 'end')
    spin0_17.insert(0, '12')
    spin0_18 = Spinbox(tab0, from_=00, to=24, width=3, format='%02.0f')
    spin0_18.delete(0, 'end')
    spin0_18.insert(0, '12')
    spin0_19 = Spinbox(tab0, from_=00, to=24, width=3, format='%02.0f')
    spin0_19.delete(0, 'end')
    spin0_19.insert(0, '12')
    spin0_20 = Spinbox(tab0, from_=00, to=24, width=3, format='%02.0f')
    spin0_20.delete(0, 'end')
    spin0_20.insert(0, '12')
    spin0_21 = Spinbox(tab0, from_=00, to=24, width=3, format='%02.0f')
    spin0_21.delete(0, 'end')
    spin0_21.insert(0, '12')
    spin0_22 = Spinbox(tab0, from_=00, to=24, width=3, format='%02.0f')
    spin0_22.delete(0, 'end')
    spin0_22.insert(0, '12')


    spin1_6 = Spinbox(tab0, from_=00, to=999, width=4, format='%03.0f')
    spin1_6.delete(0, 'end')
    spin1_6.insert(0, '01')
    spin1_7 = Spinbox(tab0, from_=00, to=999, width=4, format='%03.0f')
    spin1_7.delete(0, 'end')
    spin1_7.insert(0, '01')
    spin1_8 = Spinbox(tab0, from_=00, to=999, width=4, format='%03.0f')
    spin1_8.delete(0, 'end')
    spin1_8.insert(0, '01')
    spin1_9 = Spinbox(tab0, from_=00, to=999, width=4, format='%03.0f')
    spin1_9.delete(0, 'end')
    spin1_9.insert(0, '01')
    spin1_10 = Spinbox(tab0, from_=00, to=999, width=4, format='%03.0f')
    spin1_10.delete(0, 'end')
    spin1_10.insert(0, '01')
    spin1_11 = Spinbox(tab0, from_=00, to=999, width=4, format='%03.0f')
    spin1_11.delete(0, 'end')
    spin1_11.insert(0, '01')
    spin1_12 = Spinbox(tab0, from_=00, to=999, width=4, format='%03.0f')
    spin1_12.delete(0, 'end')
    spin1_12.insert(0, '01')
    spin1_13 = Spinbox(tab0, from_=00, to=999, width=4, format='%03.0f')
    spin1_13.delete(0, 'end')
    spin1_13.insert(0, '01')
    spin1_14 = Spinbox(tab0, from_=00, to=999, width=4, format='%03.0f')
    spin1_14.delete(0, 'end')
    spin1_14.insert(0, '01')
    spin1_15 = Spinbox(tab0, from_=00, to=999, width=4, format='%03.0f')
    spin1_15.delete(0, 'end')
    spin1_15.insert(0, '01')

    spin1_16 = Spinbox(tab0, from_=00, to=999, width=4, format='%03.0f')
    spin1_16.delete(0, 'end')
    spin1_16.insert(0, '01')
    spin1_17 = Spinbox(tab0, from_=00, to=999, width=4, format='%03.0f')
    spin1_17.delete(0, 'end')
    spin1_17.insert(0, '01')
    spin1_18 = Spinbox(tab0, from_=00, to=999, width=4, format='%03.0f')
    spin1_18.delete(0, 'end')
    spin1_18.insert(0, '01')
    spin1_19 = Spinbox(tab0, from_=00, to=999, width=4, format='%03.0f')
    spin1_19.delete(0, 'end')
    spin1_19.insert(0, '01')
    spin1_20 = Spinbox(tab0, from_=00, to=999, width=4, format='%03.0f')
    spin1_20.delete(0, 'end')
    spin1_20.insert(0, '01')
    spin1_21 = Spinbox(tab0, from_=00, to=999, width=4, format='%03.0f')
    spin1_21.delete(0, 'end')
    spin1_21.insert(0, '01')
    spin1_22 = Spinbox(tab0, from_=00, to=999, width=4, format='%03.0f')
    spin1_22.delete(0, 'end')
    spin1_22.insert(0, '01')
    spin1_23 = Spinbox(tab0, from_=00, to=999, width=4, format='%03.0f')
    spin1_23.delete(0, 'end')
    spin1_23.insert(0, '01')
    spin1_24 = Spinbox(tab0, from_=00, to=999, width=4, format='%03.0f')
    spin1_24.delete(0, 'end')
    spin1_24.insert(0, '01')
    spin1_25 = Spinbox(tab0, from_=00, to=999, width=4, format='%03.0f')
